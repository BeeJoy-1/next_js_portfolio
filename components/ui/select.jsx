...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-[48px] w-full justify-between items-center rounded-md border border-white/10 text-white/60 font-light bg-primary px-4 py-5 text-base placeholder:text-white/60 focus: border-accent outline-none",
      className
    )}
    {...props}>
    {children}
